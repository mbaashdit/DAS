...
import com.aashdit.districtautomationsystem.PhotoNotUploadListActivity;
...
public class PhotoNotUploadedClosureFragment extends Fragment {
    ...
    public PhotoNotUploadedClosureFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_photo_not_uploaded_closure, container, false);
        ...
        searchbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RegPrefManager.getInstance(getContext()).setProjectCloserNotUploadedList(sdate,edate);
