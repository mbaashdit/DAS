...
public class PhotoUploadClosureAdapter extends RecyclerView.Adapter<PhotoUploadClosureAdapter.ChangeLocationHolder> {
    //this context we will use to inflate the layout
    private Context mCtx;
 private double latitude;
 private double longitude;
    //we are storing all the products in a list
    private List<ProjectClosureUploadedTenderlist> photosList;

    //getting the context and product list with constructor
    public PhotoUploadClosureAdapter(Context mCtx, List<ProjectClosureUploadedTenderlist> photosList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(ChangeLocationHolder holder, int position) {
        ...
        ProjectClosureUploadedTenderlist photoDTO1 = photosList.get(position);
